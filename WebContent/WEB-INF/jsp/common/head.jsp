    ...
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            ...
            <script type="text/javascript">
                function logout(){
                	var flag = confirm("是否真的要退出  退出系统会回到登录页面");
                	if (flag){
                		location.href=$("#path").val()+"/user/logout.html";
                	}
     ...
     <div class="left">
         ...
         <nav>
             <ul class="list">
              ...
              <li><a href="${pageContext.request.contextPath }/auth/user/userlist">用户管理</a></li>
              <li><a href="${pageContext.request.contextPath }/auth/user/topwdmodify">密码修改</a></li>
